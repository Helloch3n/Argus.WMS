...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Argus.WMS.DataSync.DataSyncTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.Inbound.Receipt", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.Inbound.ReceiptDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.Inventorys.Inventory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.Inventorys.InventoryTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.MasterData.Locations.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.MasterData.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.MasterData.Supplier", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.MasterData.Zones.Zone", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.Outbound.PickTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.Putaway.PutawayTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Argus.WMS.Inbound.ReceiptDetail", b =>
                {
                    b.HasOne("Argus.WMS.MasterData.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Argus.WMS.Inbound.Receipt", null)
                        .WithMany("Details")
                        .HasForeignKey("ReceiptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Argus.WMS.MasterData.Reels.Reel", "Reel")
                        .WithMany()
            ...
            modelBuilder.Entity("Argus.WMS.Inventorys.InventoryTransaction", b =>
                {
                    b.HasOne("Argus.WMS.MasterData.Locations.Location", "FromLocation")
                        .WithMany()
                        .HasForeignKey("FromLocationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Argus.WMS.MasterData.Warehouses.Warehouse", "FromWarehouse")
                        .WithMany()
                    ...
                    b.HasOne("Argus.WMS.MasterData.Locations.Location", "ToLocation")
                        .WithMany()
                        .HasForeignKey("ToLocationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Argus.WMS.MasterData.Warehouses.Warehouse", "ToWarehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("Argus.WMS.MasterData.Reels.Reel", b =>
                {
                    b.HasOne("Argus.WMS.MasterData.Locations.Location", null)
                        .WithMany()
